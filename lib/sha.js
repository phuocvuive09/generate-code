  ...
  var charSize = 8,
    ...
    str2binb = function (a) {
      ...
      for (i = 0; i < length; i += charSize) {
        b[i >> 5] |=
          (a.charCodeAt(i / charSize) & mask) << (32 - charSize - (i % 32));
      }
      return b;
    },
    hex2binb = function (a) {
    ...
    binb2b64 = function (a) {
      ...
      for (i = 0; i < length; i += 3) {
        triplet =
          (((a[i >> 2] >> (8 * (3 - (i % 4)))) & 0xff) << 16) |
          (((a[(i + 1) >> 2] >> (8 * (3 - ((i + 1) % 4)))) & 0xff) << 8) |
          ((a[(i + 2) >> 2] >> (8 * (3 - ((i + 2) % 4)))) & 0xff);
        for (j = 0; j < 4; j += 1) {
    ...
    sigma0_64 = function (x) {
      var a = rotr_64(x, 28),
        ...
        rotr39 = rotr_64(x, 39);
      return new Int_64(
        a.highOrder ^ rotr34.highOrder ^ rotr39.highOrder,
        a.lowOrder ^ rotr34.lowOrder ^ rotr39.lowOrder
      );
    },
    ...
    sigma1_64 = function (x) {
      var a = rotr_64(x, 14),
        ...
        rotr41 = rotr_64(x, 41);
      return new Int_64(
        a.highOrder ^ rotr18.highOrder ^ rotr41.highOrder,
        a.lowOrder ^ rotr18.lowOrder ^ rotr41.lowOrder
      );
    },
    ...
    gamma0_64 = function (x) {
      var a = rotr_64(x, 1),
        ...
        shr7 = shr_64(x, 7);
      return new Int_64(
        a.highOrder ^ rotr8.highOrder ^ shr7.highOrder,
        a.lowOrder ^ rotr8.lowOrder ^ shr7.lowOrder
      );
    },
    ...
    gamma1_64 = function (x) {
      var a = rotr_64(x, 19),
        ...
        shr6 = shr_64(x, 6);
      return new Int_64(
        a.highOrder ^ rotr61.highOrder ^ shr6.highOrder,
        a.lowOrder ^ rotr61.lowOrder ^ shr6.lowOrder
      );
    },
    ...
    coreSHA2 = function (j, k, l) {
      ...
      for (i = 0; i < appendedMessageLength; i += binaryStringInc) {
        ...
        for (t = 0; t < numRounds; t += 1) {
          if (t < 16) {
            W[t] = new Int(
              j[t * binaryStringMult + i],
              j[t * binaryStringMult + i + 1]
            );
          } else {
            W[t] = safeAdd_4(
              gamma1(W[t - 2]),
